...
export default async function UserPage({params}) {
  ...
  return (
    <div className="bg-blue-950 text-white min-h-screen">
      <div
        ...
        style={
          page && page.bgType === 'color'
            ? { backgroundColor: page.bgColor }
            : page && page.bgType === 'image'
  ...
  <div className="aspect-square w-36 h-36 mx-auto relative -top-16 -mb-12">
    ...
    />
      ...
      <h2 className="text-2xl text-center mb-1">{page && page.displayName}</h2>
      ...
      <div className="flex gap-2 justify-center mt-4 pb-4">
        {Object.keys(page.buttons).map(buttonKey => (
          <Link key={buttonKey} href={buttonLink(buttonKey,page && page.buttons[buttonKey])}
